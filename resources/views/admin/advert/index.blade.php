            ...
            <div class="card-body">
                <form action="{{ route('admin.advert.update', 1) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <label for="">{{ __('admin.Home Middle Page Advert') }}</label>
                        <input name="home_middle_page_advert" type="file" class="form-control" >
                        @error('home_middle_page_advert')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                        <label for="" class="mt-3">{{ __('admin.Home Middle Page Advert Url') }}</label>
                    ...
                    <h5 class="text-primary">{{ __('admin.News Details Page Adverts') }}</h5>
                    <div class="form-group">
                        <img src="{{ asset($advert->news_details_page_advert) }}" width="200px" alt="">
                        <br>
                        <label for="">{{ __('admin.News Details Page Advert') }}</label>
                        <input name="news_details_page_advert" type="file" class="form-control" >
                        @error('news_details_page_advert')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                        <label for="" class="mt-3">{{ __('admin.News Details Page Advert Url') }}</label>
                    ...
                    <h5 class="text-primary">{{ __('admin.News Search Page Adverts') }}</h5>
                    <div class="form-group">
                        <img src="{{ asset($advert->news_page_advert) }}" width="200px" alt="">
                        <br>
                        <label for="">{{ __('admin.News Search Page Advert') }}</label>
                        <input name="news_page_advert" type="file" class="form-control" >
                        @error('news_page_advert')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                        <label for="" class="mt-3">{{ __('admin.News Search Page Advert Url') }}</label>
                    ...
                    <h5 class="text-primary">{{ __('admin.Sidebar Adverts') }}</h5>
                    <div class="form-group">
                        <img src="{{ asset($advert->side_bar_advert) }}" width="200px" alt="">
                        <br>
                        <label for="">{{ __('admin.Sidebar Advert') }}</label>
                        <input name="side_bar_advert" type="file" class="form-control" >
                        @error('side_bar_advert')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                        <label for="" class="mt-3">{{ __('admin.Sidebar Advert Url') }}</label>

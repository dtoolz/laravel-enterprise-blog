                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.footer-grid-three-title') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="">{{ __('admin.Footer Grid Three Title') }}</label>
                                ...
                                <table class="table table-striped" id="table-{{ $language->lang }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.footer-grid-three.edit', $item->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('admin.footer-grid-three.destroy', $item->id) }}" class="btn btn-danger delete-item"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>

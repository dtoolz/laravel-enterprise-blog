        ...
        <ul class="sidebar-menu">
            ...
            @if (canAccess(['contact message index']))
                <li class="{{ setSidebarActive(['admin.contact-form-message.*']) }}"><a class="nav-link"
                        href="{{ route('admin.contact-form-message.index') }}"><i class="fas fa-id-card-alt"></i>
            ...
            @if (canAccess(['advertisement index']))
                <li class="{{ setSidebarActive(['admin.advert.*']) }}"><a class="nav-link"
                        href="{{ route('admin.advert.index') }}"><i class="fas fa-ad"></i>
            ...
            @if (canAccess(['languages index']))
                <li
                    class="dropdown
               {{ setSidebarActive(['admin.frontend-localization.index', 'admin.admin-localization.index']) }}">
            ...
            @if (canAccess(['access management index']))
                <li class="dropdown {{ setSidebarActive([
                    ...
                    <a href="#" class="nav-link has-dropdown"><i
                            class="fas fa-user-shield"></i><span>{{ __('admin.Access Mgt') }}</span></a>
                    <ul class="dropdown-menu">

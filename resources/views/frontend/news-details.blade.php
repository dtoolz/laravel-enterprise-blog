            ...
            <div class="row">
                    ...
                    @auth
                        <div id="comments" class="comments-area">
                            @if ($news->comments()->count() == 0)
                                <h3 class="comments-title">{{ __('frontend.No') }} {{ __('frontend.Comment') }}:</h3>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                            {{ __('frontend.Write Your Reply') }}</h5>
                ...
                <div class="col-md-4">
                    <div class="sticky-top">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary newsletter-button"
                                                type="submit">{{ __('frontend.subscribe') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        @endif
                        <div class="input-group-append">
                            <button class="btn btn-primary" type="button">{{ __('frontend.sign up') }}</button>
                        </div>
        ...
        $(document).ready(function() {
            $('.delete-msg').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    text: '{{ __('frontend.You would not be able to revert this!') }}',
                    icon: 'warning',

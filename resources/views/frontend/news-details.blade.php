                                                    ...
                                                    <div class="wrap__article-detail">
                                                        ...
                                                        <div class="wrap__article-detail-content">
                                                            ...
                                                            <p class="has-drop-cap-fluid">
                                                                ...
                                                                thousands of bad Commas, wild
                                                                Question Marks and
                                                                devious Semikoli, but the Little Blind Text didn’t listen.
                                                                On her way she met a copy.
                                                                The copy warned the
                                                                Little Blind Text, that where it came from it would have
                                                                been rewritten a thousand times
                                                                and everything that
                                                                was left from its origin would be the word “and” and the
                                                                Little Blind Text should turn
                                                        ...
                                                        <div class="wrap__profile-author">
                                                            ...
                                                            <div class="wrap__profile-author-detail">
                                                                ...
                                                                <ul class="list-inline">
                                                                    ...
                                                                    <li class="list-inline-item">
                                                                        <a href="#"
                                                                            class="btn btn-social btn-social-o telegram ">
                                                                            <i class="fa fa-telegram"></i>
                                                                        </a>
                                                                    </li>
                                                                    <li class="list-inline-item">
                                                        ...
                                                        <ol class="comment-list">
                                                            <li class="comment">
                                                                <aside class="comment-body">
                                                                    <div class="comment-meta">
                                                                        <div class="comment-author vcard">
                                                                            <img src="images/news2.jpg" class="avatar"
                                                                                alt="image">
                                                                            <b class="fn">Sinmun</b>
                                                                            <span class="says">says:</span>
                                                                        </div>
                                                            ...
                                                            <li class="comment">
                                                                <aside class="comment-body">
                                                                    <div class="comment-meta">
                                                                        <div class="comment-author vcard">
                                                                            <img src="images/news4.jpg" class="avatar"
                                                                                alt="image">
                                                                            <b class="fn">Sinmun</b>
                                                                            <span class="says">says:</span>
                                                                        </div>
                                                    ...
                                                    <div class="sticky-top">
                                                                        ...
                                                                        <div class="card__post__body ">
                                                                            <div class="card__post__content">
                                                                                ...
                                                                                <div class="card__post__title">
                                                                                    <h6>
                                                                                        <a href="./blog_details.html">
                                                                                            6 Best Tips for Building a Good
                                                                                            Shipping Boat
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                        ...
                                                        <aside class="wrapper__list__article">
                                                            ...
                                                            <div class="widget__form-subscribe bg__card-shadow">
                                                                ...
                                                                <p><small>Get magzrenvi daily newsletter on your
                                                                        inbox.</small></p>
                                                                <div class="input-group ">
